# 垃圾收集器
![垃圾收集器.jpg](collector/垃圾收集器.jpg)

以上是 HotSpot 虚拟机中的 7 个垃圾收集器，连线表示垃圾收集器可以配合使用。

### 1. Serial 收集器
![](collector/serial收集器.jpg)
...
### 2. ParNew 收集器
![parNew收集器.jpg](collector/parNew收集器.jpg)
...
### 5. Parallel Old 收集器
![parallelOld收集器.jpg](collector/parallelOld收集器.jpg)
...
### 6. CMS 收集器
![CMS收集器.jpg](collector/CMS收集器.jpg)
...
![G1收集器.png](collector/G1收集器Head.png)

G1 把新生代和老年代划分成多个大小相等的独立区域（Region），新生代和永久代不再物理隔离。

![G1收集器2.png](collector/G1收集器2.png)
...
![G1收集器region.jpg](collector/G1收集器region.jpg)
