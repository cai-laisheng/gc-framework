...
![对象，对象监视器，同步队列和线程状态的关系](keyword/对象，对象监视器，同步队列和线程状态的关系.png)
...
![synchronized的happens-before关系](keyword/synchronized的happens-before关系.png)
...
![偏向锁获取和撤销流程](keyword/偏向锁获取和撤销流程.png)
