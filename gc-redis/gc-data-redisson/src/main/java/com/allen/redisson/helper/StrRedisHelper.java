package com.allen.redisson.helper;
...
/**
 * 存储存字符传的redis工具类，与RedisRepository 功能一样，可选一
 */
//@Repository
//@DependsOn
public class StrRedisHelper {
	private static final Logger log = LoggerFactory.getLogger(StrRedisHelper.class);
