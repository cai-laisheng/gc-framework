...
public class HttpSpiderUtil {
    ...
    public static String send(final String url, String content,Map<String, String> formParamMap,  HttpMethod method) {
        return send(url,content,headerMap,formParamMap,DEFAULT_CHARSET,DEFAULT_CHARSET,method);
    }
    ...
    public static void main(String[] args) {
        String result = HttpSpiderUtil.sendGet("https://www.baidu.com", null);
